...
export default async function SettingsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <><PageHeader title={locale === "ar" ? "إعدادات الموقع" : "Website settings"} description={locale === "ar" ? "إعدادات العمل العامة التي تظهر في المتجر وعند الاستلام." : "Shared business settings shown in the storefront and pickup flow."} /><SettingsForm locale={locale} values={values} /></>;
}
