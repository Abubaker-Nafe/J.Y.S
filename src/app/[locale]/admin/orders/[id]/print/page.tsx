...
import { OrderItemImage } from "@/components/admin/OrderItemImage";
...
export default async function PrintOrderPage({ params }: { params: Promise<{ locale: string; id: string }> }) {
  ...
  const locale = getAdminLocale(value);
